...
function SpotsList() { // function name defines our React component named 'SpotsList'
    ...
    return ( <div className="spots-list"> {/* this is our JSX render block when returns the actual HTML to show in the browser */}
            ...
            // Via Requirements page we will present the information like so : 
                <div key={spot.id} className="spot-card"> 
                    ...
                    <p>{spot.avgRating ?? 'New'}</p> { /* The ?? is what is called a 'nullish coalescer' which returns the right-hand value only if the left-hand valie is null or undefined */}
                </div>
            ))}
    </div>
    );
