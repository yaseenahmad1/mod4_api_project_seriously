    ...
    <>
      ...
      <div className="reviews-section">
        <h3 className="review-title">
          ★ {avgStarRating} · {numReviews} review{numReviews === 1 ? "" : "s"} {/* "DOUBLE CHECK THIS LINE if the number of reviews is 1 go with first option which is an empty string (aka no s) if it is any number other 1 then add an s*/}
        </h3>
